...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('')}}front_assets/assets/img/favicons/favicon.png">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block" style="background-image:url({{asset('')}}front_assets/assets/img/category/shape.png);opacity:.5;">
        </div>
        <!--/.bg-holder-->
      ...
      <section class="py-md-11 py-8" id="superhero">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url({{asset('')}}front_assets/assets/img/superhero/oval.png);opacity:.5; background-position: top !important ;">
        </div>
        <!--/.bg-holder-->
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('')}}front_assets/vendors/@popperjs/popper.min.js"></script>
    <script src="{{asset('')}}front_assets/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="{{asset('')}}front_assets/vendors/is/is.min.js"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{asset('')}}front_assets/vendors/fontawesome/all.min.js"></script>
    <script src="{{asset('')}}front_assets/assets/js/theme.js"></script>
